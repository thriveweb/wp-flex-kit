    	...
    	<div class="<?= $args['classes'] ?>">
      	<?php if( have_rows('layouts') ): while ( have_rows('layouts') ) : the_row(); ?>
      		...
      		<?php elseif( get_row_layout() == 'three_columns' ): ?>
      			<div class="wrap flex-row layouts three_columns">
      				<div class="one-third">
      					<?php the_sub_field('left_content'); ?>
      				</div>
      				<div class="one-third">
